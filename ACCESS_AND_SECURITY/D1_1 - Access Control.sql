...
GRANT ROLE ANALYST TO ROLE SYSADMIN; -- buena practica para que el sysadmin tenga por privilege inheritence acceso a todos los objetos creados por un custom role
...
-- si nos logeamos con el nuevo usuario tendria los privilegios del rol analyst que hemos ido creando
USE SCHEMA FILMS_DB.FILMS_SCHEMA;
